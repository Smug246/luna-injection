...
const config = {
  ...
  ping_val: '', //change to @here or <@ID> to ping specific user if you want, will only send if ping_on_run is true
  embed_name: 'Brokens Injection', //name of the webhook thats gonna send the info
